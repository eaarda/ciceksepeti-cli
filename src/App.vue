...
<script>
import homecss from './assets/css/bundle-home.css'
import layoutcss from './assets/css/bundle-layout.css'
...
import categorycss from './assets/css/bundle-category.css'
